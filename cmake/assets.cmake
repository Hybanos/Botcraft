...
# Language
if(NOT EXISTS "${BOTCRAFT_OUTPUT_DIR}/bin/Assets/${BOTCRAFT_GAME_VERSION}/minecraft/lang")
    message(STATUS "Copying language ${BOTCRAFT_TRANSLATION_LANG}")
    file(COPY "${CMAKE_CURRENT_SOURCE_DIR}/Assets/${BOTCRAFT_GAME_VERSION}/minecraft/lang/${BOTCRAFT_TRANSLATION_LANG}.json" DESTINATION "${CMAKE_CURRENT_SOURCE_DIR}/bin/Assets/${BOTCRAFT_GAME_VERSION}/minecraft/lang/${BOTCRAFT_TRANSLATION_LANG}.json")
endif()
